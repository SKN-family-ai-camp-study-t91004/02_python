...
# write : 단순 글자 뿐만 아니라, 마크다운, 표, 리스트, 차트, 입력 타입 등에 따라 출력 방식 정해짐
st.write("write 테스트!!!")
...
# 코드 블록
st.subheader("code block", divider="rainbow")
code = '''def hello():
    print("Hello, Streamlit!")'''
st.code(code, language="python", line_numbers=True)

# latex : 수식
st.subheader("latex", divider="rainbow")
st.latex(r'''
...
# 뱃지
st.subheader("badge", divider="rainbow")
st.badge("New")
...
# metric : 측량, 측정
st.subheader(":blue[metric]", divider="blue")
