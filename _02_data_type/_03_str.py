...
print('--- str.replace() ---')
today = '2026-06-01'
print(today, today.replace('-', '/')) # 메서드는 len과 다르게 앞에 today(객체)가 붙어있다.
...
print("text[0:5:1]: ", text[0:5:1]) # 0 ~ 4까지
print("text[0:5]: ", text[0:5]) # 0 ~ 4까지, step 생략 시 기본 값 1
print("text[:5]: ", text[:5]) # 0 ~ 4까지, start 생략 시 기본 값 0

print("text[6:11]: ", text[6:11]) # 6 ~ 10까지
print("text[6:len(text)]: ", text[6:len(text)]) # 6 ~ 10까지
