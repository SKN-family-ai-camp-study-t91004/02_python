...
# ['hello', '안녕']
print(texts[0:2:1]) # print(texts[:2])

# ['안녕', '곤니찌와']
print(texts[1:3])

# ['hello', '곤니찌와']
print(texts[:3:2]) # print(texts[0::2])
...
# sort: 정렬하다
# list.sort(): 원본 리스트 내에서 정렬(in-place) -> 원본 데이터가 변경(원본 데이터 손실)
# sorted(list): 정렬된 새 리스트를 반환(not-in-place) -> 원본 데이터가 별도로 유지
...
numbers = [10, 20, 30]
a, b, c = numbers # a = numbers[0], b = numbers[1], c = numbers[2]
print(a,b,c)

# d = 0번 인덱스 요소(10)
# *e = 1,2번 인덱스 요소 [20, 30] -> 나머지를 list 형태로 반환
d, *e = numbers
print(d, e)
